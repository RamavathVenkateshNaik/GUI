...
data = pd.read_csv('/home/sujith/Documents/ML/n1a1data/all_charge.csv', header = None)

original_y = data[25].values
# Generate x values corresponding to the original data
#x = np.linspace(-1.099, 1.099, 17).reshape(-1, 1)
pdf = pd.read_csv('/home/sujith/Documents/ML/n1a1data/23L/15K23L/xchdata.csv', header = None)
x = pdf[0].values.reshape(-1, 1)
print(data.shape)
