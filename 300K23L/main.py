...
# --- Load Data ---
data = pd.read_csv('/home/sujith/Documents/ML/23L/15K23L/xchdata.csv', header=None)
...
def objective(params, x, original_y, a0, tsi, n_max, n0):
    a1, n1 = params
...
for col in range(1, 22):
    ...
    n0 = nc / n_max
    n0_list.append(n0)
    #print(f"Index closest to x=0: {x_0_idx}, Value: {x[x_0_idx][0]}")
    ...
    result = differential_evolution(
        objective,
        bounds=bounds,
        args=(x, original_y, a0, tsi, n_max, n0),  # Pass n0 as a fixed parameter
    ...
    predicted_y = np.squeeze(physical_model(x, a0, best_a1, n0, best_n1, tsi, n_max))
...
plt.title('n0 vs z (Calculated as nc/nmax)')
plt.xlabel('z')
plt.ylabel('n0')
plt.grid(True)
...
print("Parameters saved to 'fitted_parameters.csv'")
